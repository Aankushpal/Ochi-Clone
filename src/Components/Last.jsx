...
const Last = () => {
  return (
    <>
        <div data-scroll data-scroll-speed="-.1" className="w-full h-[110vh] bg-[#F1F1F1]">
            <div className="bg-[#F1F1F1] w-full h-screen px-14 pt-24 flex">
                <div className="a1 h-full w-1/2">
                <h1 className='font-bold text-[7vw] leading-[6vw] uppercase tracking-tighter font-["Founder Grotesks"]'>EYE- <br /> <span className='tracking-[-.5vw]'>opening</span></h1>
                </div>
                <div className="a2 flex flex-col px-2">
                    <h1 className='font-bold text-[6vw] leading-[6vw] uppercase tracking-[-.4vw] font-["Founder Grotesks"]'>presentations</h1>
                    <h2 className='text-[1.2vw] font-["Neue Montreal"] mt-[3vw] mb-[1.5vw]'>S:</h2>
                    <h5 className='text-[1.2vw]'>Instagram</h5>
                    <h5 className='text-[1.2vw]'>Behance</h5>
                    <h5 className='text-[1.2vw]'>Facebook</h5>
                    <h5 className='text-[1.2vw]'>LinkedIn</h5>
                    <h2 className='text-[1.2vw] font-["Neue Montreal"] mt-[2vw] mb-[1.2vw]'>E:</h2>
                    <h5 className='text-[1.2vw]'>ankushpal16200@gmail.com</h5>
                </div>
            </div>
            <div className="footer px-14 flex ">
                <div className="svg w-1/2">
                <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className='px-2 mt-3 font-semibold tracking-tight text-[#9999]'>@OCHI DESIGN 2024</h1>
                </div>
        </div>
    </>
  )
